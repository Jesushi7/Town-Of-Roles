...
namespace TownOfSushi.Roles
{
    public class Survivor : Role
    {
        ...
        {
            Name = "Survivor";
            ImpostorText = () => "<color=#FFE64DFF>Stay alive and win with whoever wins the game\n except for Neutral Evil Roles.</color>";
            TaskText = () => SpawnedAs ? "Stay alive to win" : "Your target has died. Now you just need to live";
