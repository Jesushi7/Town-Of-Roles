...
namespace TownOfRoles.Roles.Modifiers
{
    public class Assassin : Ability
    {
        ...
        public Assassin(PlayerControl player) : base(player)
        {
            ...
            if (CustomGameOptions.GamblerOn > 0) ColorMapping.Add("Gambler", Colors.Gambler);
            ...
            // Add Neutral Non-Killing Roles if enabled
            ...
            // Add Neutral Killing Roles if enabled
            ...
            if (CustomGameOptions.AssassinGuessImpostors)
            {
            ...
            if (CustomGameOptions.AssassinGuessModifiers && CustomGameOptions.ButtonBarryOn > 0) ColorMapping.Add("Button Barry", Colors.Modifiers);    
