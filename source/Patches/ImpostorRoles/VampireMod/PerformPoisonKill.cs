...
namespace TownOfRoles.ImpostorRoles.VampireMod
{
    ...
    public class PerformBiteKill
    {
        ...
        public static bool Prefix(KillButton __instance)
        {
            ...
            {
                role.BiteButton.SetCoolDown(0.01f, 1f);
                return false;
            }
            ...
            if (role.ClosestPlayer.IsOnAlert())
            {
                ...
                else if (role.Player.IsShielded())
                {
                    ...
                    {
                        role.BittenPlayer = target;
                        role.BiteButton.SetTarget(null);
                ...
                else
                {
                    ...
                    {
                        role.LastBitten.AddSeconds(CustomGameOptions.ProtectKCReset + 0.01f);
                        role.BiteButton.SetCoolDown(0.01f, 1f);
                    }
                }
                return false;
