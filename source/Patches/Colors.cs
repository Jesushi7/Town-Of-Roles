...
namespace TownOfSushi.Patches
{
    class Colors {
        ...
        // Crew Colors
        public readonly static Color Monarch = new Color(0.44f, 0.31f, 0.66f, 1f);
        public readonly static Color Sheriff = new Color32(248, 205, 70, 255); 
        ...
        public readonly static Color Vigilante = Color.yellow;
        ...
        public readonly static Color Nightowl = new Color(1f, 1f, 0.6f, 1f);
