...
using TownOfSushi.CrewmateRoles.MediumMod;
...
namespace TownOfSushi
{
    ...
    public static class CustomGameOptions
    {
        ...
        public static float DetectiveArrowDuration => Generate.DetectiveArrowDuration.Get();
        ...
        public static float DetExamineCd => Generate.ExamineCooldown.Get();
        ...
        public static int MonarchCultistOn => (int)Generate.MonarchCultistOn.Get();
        ...
        public static int MaxInformantes => (int)Generate.MaxInformantes.Get();
