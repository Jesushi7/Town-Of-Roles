...
namespace TownOfSushi.CustomOption
{
    public class Generate
    {
        ...
        public static CustomNumberOption MonarchCultistOn;
        ...
        public static CustomNumberOption MaxInformantes;
        ...
        public static CustomNumberOption DetectiveArrowDuration;
        ...
        public static CustomNumberOption DetExamineCooldown;
        ...
        public static void GenerateAll()
        {
            ...
            OracleOn = new CustomNumberOption(num++, MultiMenu.crewmate, "<color=#BF00BFFF>Oracle</color>", 0f, 0f, 100f, 10f,
                PercentFormat);
            SnitchOn = new CustomNumberOption(num++, MultiMenu.crewmate, "<color=#FFCC80FF>Snitch</color>", 0f, 0f, 100f, 10f,
                PercentFormat);
            ...
            VeteranOn = new CustomNumberOption(num++, MultiMenu.crewmate, "<color=#998040FF>Veteran</color>", 0f, 0f, 100f, 10f,
                PercentFormat);
            VigilanteOn = new CustomNumberOption(num++, MultiMenu.crewmate, "<color=#FFFF00FF>Vigilante</color>", 0f, 0f, 100f, 10f,
                PercentFormat);
            ...
            ImitatorOn = new CustomNumberOption(num++, MultiMenu.crewmate, "<color=#B3D94DFF>Imitator</color>", 0f, 0f, 100f, 10f,
                PercentFormat);              
            MonarchOn = new CustomNumberOption(num++, MultiMenu.crewmate, "<color=#704FA8FF>Monarch</color>", 0f, 0f, 100f, 10f,
                PercentFormat);
            ...
            MonarchCultistOn = new CustomNumberOption(num++, MultiMenu.main, "<color=#704FA8FF>Monarch</color> (Cultist Mode)", 100f, 0f, 100f, 10f,
                PercentFormat);
            SnitchCultistOn = new CustomNumberOption(num++, MultiMenu.main, "<color=#FFCC80FF>Snitch</color> (Cultist Mode)", 100f, 0f, 100f, 10f,
                PercentFormat);
            ...
            MaxMystics =
                new CustomNumberOption(num++, MultiMenu.main, "Max Detectives", 3, 0, 5, 1);
            MaxInformantes =
                new CustomNumberOption(num++, MultiMenu.main, "Max Informantes", 3, 0, 5, 1);
            MaxSpies =
            ...
            MayorButton =
                new CustomToggleOption(num++, MultiMenu.crewmate, "Mayor Can Button", false);
            ...
            AvengerTasksRemainingClicked =
                 new CustomNumberOption(num++, MultiMenu.crewmate, "Tasks Remaining When Avenger Can Be Clicked", 5, 1, 15, 1);
            ...
            SnitchCooldown =
                new CustomNumberOption(num++, MultiMenu.crewmate, "Snitch Cooldown", 25f, 10f, 60f, 2.5f, CooldownFormat);
            CrewKillingRed =
            ...
            InformantSeesNeutrals = new CustomToggleOption(num++, MultiMenu.crewmate, "Informant Sees Neutral Roles", false);
            InformantTasksRemaining =
                 new CustomNumberOption(num++, MultiMenu.crewmate, "Tasks Remaining When Revealed", 1, 1, 5, 1);
            InformantSeesImpInMeeting = new CustomToggleOption(num++, MultiMenu.crewmate, "Informant Sees Impostors In Meetings", true);
            InformantSeesTraitor = new CustomToggleOption(num++, MultiMenu.crewmate, "Informant Sees Traitor", true);
            ...
            JesterKill =
                new CustomToggleOption(num++, MultiMenu.neutral, "Enable Jester Kill Button", false);                 
            JesterButton =
            ...
            JesterSwitchVent =
            new CustomToggleOption(num++, MultiMenu.neutral, "Jester Can Switch Between Vents", false);                
            JesterImpVision =
