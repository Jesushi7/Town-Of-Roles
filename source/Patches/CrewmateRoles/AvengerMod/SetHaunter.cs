...
namespace TownOfRoles.CrewmateRoles.AvengerMod
{
    ...
    public class SetAvenger
    {
        ...
        public static void ExileControllerPostfix(ExileController __instance)
        {
            ...
            if (WillBeAvenger != null && !WillBeAvenger.Data.IsDead && exiled.Is(Faction.Crewmates)) WillBeAvenger = exiled;
            ...
            if (!PlayerControl.LocalPlayer.Is(RoleEnum.Avenger))
            {
                ...
                System.Console.WriteLine("Become Avenger - Avenger");

                PlayerControl.LocalPlayer.gameObject.layer = LayerMask.NameToLayer("Players");

                var writer = AmongUsClient.Instance.StartRpcImmediately(PlayerControl.LocalPlayer.NetId,
                    (byte) CustomRPC.AvengerDied, SendOption.Reliable, -1);
