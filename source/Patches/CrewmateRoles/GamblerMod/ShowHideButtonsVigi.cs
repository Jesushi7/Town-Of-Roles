...
namespace TownOfRoles.CrewmateRoles.GamblerMod
{
    ...
    public class ShowHideButtonsGambler
    {
        public static void HideButtonsGambler(Gambler role)
        {
        ...
        )
        {
            if (
                ...
                !CustomGameOptions.GamblerMultiKill
            )
            {
                HideButtonsGambler(role);
                return;
            }
        ...
        public static void Prefix(MeetingHud __instance)
        {
            ...
            if (!CustomGameOptions.GamblerAfterVoting) HideButtonsGambler(retributionist);
        }
    }
}
