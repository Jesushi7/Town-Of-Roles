        ...
        public static void Postfix(PlayerControl __instance)
        {
            ...
            switch (tasksLeft)
            {
                ...
                case 5:
                    if (tasksLeft == CustomGameOptions.InformantTasksRemaining)
                    {
                        ...
                        if (PlayerControl.LocalPlayer.Is(RoleEnum.Informant))
                        {
                            ...
                            || ((PlayerControl.LocalPlayer.Is(Faction.NeutralKilling)) && CustomGameOptions.InformantSeesNeutrals))
                        {
                            Coroutines.Start(Utils.FlashCoroutine(role.Color));
                ...
                case 0:
                    ...
                    else if (PlayerControl.LocalPlayer.Data.IsImpostor() || (PlayerControl.LocalPlayer.Is(Faction.NeutralKilling) && CustomGameOptions.InformantSeesNeutrals))
                    {
                        Coroutines.Start(Utils.FlashCoroutine(Color.green));
                    }
