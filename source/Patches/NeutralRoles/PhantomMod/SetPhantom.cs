...
namespace TownOfSushi.NeutralRoles.PhantomMod
{
    ...
    public class SetPhantom
    {
        ...
        public static void ExileControllerPostfix(ExileController __instance)
        {
            ...
            if (!WillBePhantom.Data.IsDead && (exiled.Is(Faction.NeutralKilling) || exiled.Is(Faction.NeutralEvil) || exiled.Is(Faction.NeutralBenign))) WillBePhantom = exiled;
            ...
            if (!WillBePhantom.Is(RoleEnum.Phantom))
            {
                ...
                if (!PlayerControl.LocalPlayer.Is(RoleEnum.Avenger)) WillBePhantom.MyPhysics.ResetMoveState();
